        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex items-center space-x-3.5">
            <div className="relative">
              <div className="w-11 h-11 rounded-xl bg-blue-600 flex items-center justify-center text-white shadow-lg shadow-blue-600/30 ring-1 ring-blue-400/40">
                <span className="font-extrabold text-xl text-white">N</span>
              </div>
              <span className="absolute -bottom-1 -right-1 bg-[#0A0C10] text-blue-400 font-extrabold text-[9px] px-1 py-0.2 rounded border border-blue-500/40 uppercase tracking-widest font-mono">
                2026
              </span>
            </div>
            ...
            <div>
              <div className="flex items-center space-x-2 mb-0.5">
                <span className="text-[10px] tracking-[0.25em] uppercase text-slate-500 font-semibold font-mono">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-3">
            <button
              ...
              className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-bold text-sm shadow-lg shadow-blue-600/25 transition-all cursor-pointer"
            >
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-3.5 py-2.5 rounded-lg bg-[#14171D] hover:bg-slate-800 text-slate-200 font-semibold text-sm border border-slate-800 transition-all cursor-pointer"
            ...
            <button
              id="btn-reset-data"
              onClick={onResetData}
              className="inline-flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-lg bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 font-semibold text-xs border border-rose-500/30 transition-all cursor-pointer"
            ...
            <div className="flex items-center gap-1 bg-[#14171D] border border-slate-800/80 p-1 rounded-lg">
              <button
                id="btn-export-json"
                onClick={onExportData}
                className="p-2 rounded-md hover:bg-slate-800 text-slate-400 hover:text-white transition-colors cursor-pointer"
